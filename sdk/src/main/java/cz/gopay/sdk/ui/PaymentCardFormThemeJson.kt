...
data class PaymentCardFormThemeJson(
    ...
    val inputBorderCollapse: Boolean? = null,
    val focusRingWidth: Float? = null,
    val focusRingColor: String? = null,
    val focusGradientStart: String? = null,
    val focusGradientEnd: String? = null,
    ...
    fun toTheme(
        ...
        inputBorderCollapse = inputBorderCollapse ?: base.inputBorderCollapse,
        focusRingWidth = focusRingWidth.toLengthOrNull() ?: base.focusRingWidth,
        focusRingColor = focusRingColor.toOptionalColorOr(base.focusRingColor, "focusRingColor"),
        focusGradientStart = focusGradientStart.toColorOr(base.focusGradientStart, "focusGradientStart"),
        focusGradientEnd = focusGradientEnd.toColorOr(base.focusGradientEnd, "focusGradientEnd"),
    ...
    companion object {
        ...
        fun parse(document: String): PaymentCardFormThemeJson {
            ...
            return PaymentCardFormThemeJson(
                ...
                inputBorderCollapse = values.boolean("inputBorderCollapse"),
                focusRingWidth = values.number("focusRingWidth"),
                focusRingColor = values.string("focusRingColor"),
                focusGradientStart = values.string("focusGradientStart"),
                focusGradientEnd = values.string("focusGradientEnd"),
...
fun PaymentCardFormTheme.toJsonModel(): PaymentCardFormThemeJson = PaymentCardFormThemeJson(
    ...
    inputBorderCollapse = inputBorderCollapse,
    focusRingWidth = focusRingWidth?.jsonValueOrNull(),
    focusRingColor = focusRingColor?.toHexStringOrNull(),
    focusGradientStart = focusGradientStart.toHexStringOrNull(),
    focusGradientEnd = focusGradientEnd.toHexStringOrNull(),
